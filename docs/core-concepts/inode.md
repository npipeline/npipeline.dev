---
title: INode and its Derivatives
description: Learn about the different types of nodes that form the building blocks of a pipeline.
sidebar_position: 3
slug: /core-concepts/inode
---

# INode and its Derivatives

In NPipeline, nodes are the fundamental units of work. Every operation in a pipeline, from data generation to transformation and final output, is performed by a node. All nodes inherit from the base `INode` marker interface.
